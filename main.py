...
os.system("sudo apt purge fprintd libpam-fprintd -y")

# Installs the necessary tools and dependencies required to compile and work with libfprint.
os.system("sudo apt install meson cmake libglib2.0-dev libgusb-dev libcairo2-dev libgirepository1.0-dev libnss3-dev libgudev-1.0-dev gtk-doc-tools valgrind -y")
...
os.system("sudo apt install fprintd libpam-fprintd -y")
